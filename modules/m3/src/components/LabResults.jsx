...
//   const LabRow = ({ item }) => (
//     <tr key={item.id} className={`hover:bg-slate-50 transition-colors border-b border-slate-50 last:border-0 ${item.status === 'Elevated' ? 'bg-amber-50/30' : ''}`}>
//       <td className="px-4 md:px-8 py-4 align-middle">
//         <div className="font-bold text-slate-900 text-sm">{item.name}</div>
//         <div className="text-[12px] font-bold text-blue-600 uppercase tracking-tighter">{item.lab}</div>
//       </td>
      
//       <td className="px-4 md:px-8 py-4 text-center align-middle">
//         <div className="flex flex-col items-center justify-center">
//             <div className="flex items-baseline gap-1">
//                 <span className={`text-xs md:text-[15px] font-black text-blue-600'}`}>
//                     {item.value}
//                 </span>
...
//         <span className="inline-block px-2 py-0.5 bg-slate-50 text-black rounded-md text-[15px] font-mono font-bold border border-slate-200 min-w-[60px]">
//           {item.refRange}
//         </span>
//       </td>
...
//             item.status === 'Elevated' ? 'bg-amber-100 text-amber-700 border-amber-200' : 'bg-slate-50 text-blue-400 border-slate-200'
//             }`}>
//             {item.status}
//             </span>
//         </div>
...
//             <p className="text-[9px] md:text-[10px] font-bold text-sky-700 uppercase tracking-widest mt-0.5">
//               {loading ? "Syncing..." : `Showing ${recentItems.length} Recent`}
//             </p>
//           </div>
//         </div>
//         <button 
//           className="cursor-pointer bg-slate-900 text-white px-4 py-2 md:px-6 md:py-2.5 rounded-xl text-[10px] md:text-[11px] font-black uppercase tracking-widest hover:bg-blue-600 transition-all active:scale-95 shadow-md" 
...
//             className=" cursor-pointer group flex items-center gap-3 py-2.5 px-6 bg-white border border-slate-200 rounded-full text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest hover:border-blue-400 hover:text-blue-600 transition-all"
//           >
//             <span>Complete Lab History</span>
//             <span className="bg-slate-100 px-2 py-0.5 rounded-md text-[9px] border border-slate-200">
//               {items.length}
//             </span>
//             <span>→</span>
//           </button>
...
//           <div className="bg-white w-full max-w-5xl h-full max-h-[90vh] rounded-[2rem] shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
...
//               <button onClick={() => setFullHistoryOpen(false)} className="w-10 h-10 rounded-full bg-slate-50 flex items-center justify-center text-slate-900 font-bold border border-slate-200">✕</button>
//             </div>
//             <div className="overflow-y-auto flex-1 p-4 md:p-6">
//                <table className="w-full text-left">
//                   <tbody className="divide-y divide-slate-50">{items.map(item => <LabRow key={item.id} item={item} />)}</tbody>
//                </table>
//             </div>
//           </div>
//         </div>
...
//               <select 
//                 className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none transition-all" 
//                 value={test} 
...
//               <input type="number" step="any" className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none" value={value} onChange={(e) => setValue(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Observation Date*</label>
//               <input type="date" className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none" value={date} onChange={(e) => setDate(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Lab Facility</label>
//               <input className="w-full border border-slate-200 bg-slate-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none" value={lab} onChange={(e) => setLab(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Reference Range</label>
//               <input className="w-full bg-slate-100 border border-slate-200 text-slate-950 rounded-xl px-4 py-3 text-sm font-bold italic" value={range} readOnly />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Units</label>
//               <input className="w-full bg-slate-100 border border-slate-200 text-slate-950 rounded-xl px-4 py-3 text-sm font-bold italic" value={unit} readOnly />
//             </div>
//           </div>

//           <div className="flex justify-end gap-3 pt-6 border-t border-slate-100">
//             <button className="px-6 py-3 rounded-xl text-[11px] font-black text-slate-950 uppercase tracking-widest hover:bg-slate-50" onClick={() => setOpen(false)}>Discard</button>
//             <button 
//               className="bg-slate-900 text-white px-10 py-3.5 rounded-xl text-[11px] font-black uppercase tracking-widest shadow-lg hover:bg-blue-600 transition-all disabled:bg-slate-300" 
//               onClick={submit} 
//               disabled={loading}
//             >
//               Commit Result
...
//   const LabRow = ({ item }) => (
//     <tr key={item.id} className={`hover:bg-emerald-50/30 transition-colors border-b border-slate-50 last:border-0 ${item.status === 'Elevated' ? 'bg-amber-50/30' : ''}`}>
//       <td className="px-4 md:px-8 py-4 align-middle">
//         <div className="font-bold text-slate-900 text-sm">{item.name}</div>
//         <div className="text-[12px] font-bold text-emerald-600 uppercase tracking-tighter">{item.lab}</div>
//       </td>
      
//       <td className="px-4 md:px-8 py-4 text-center align-middle">
//         <div className="flex flex-col items-center justify-center">
//             <div className="flex items-baseline gap-1">
//                 <span className={`text-xs md:text-[15px] font-black text-emerald-600'}`}>
//                     {item.value}
//                 </span>
//                 <span className="text-[9px] md:text-[15px] font-bold text-black uppercase tracking-tighter">{item.units}</span>
//             </div>
...
//         <div className="flex justify-center">
//             <span className={`inline-block w-24 py-1 rounded-full text-[9px] md:text-[12px] font-black uppercase tracking-widest border shadow-sm ${
//             item.status === 'Elevated' ? 'bg-amber-100 text-amber-700 border-amber-200' : 'bg-emerald-50 text-emerald-600 border-emerald-200'
//             }`}>
//             {item.status}
//             </span>
//         </div>
...
//   return (
//     <div className="border border-emerald-200 mx-2 md:mx-8 my-4 card shadow-sm rounded-2xl flex flex-col h-full bg-white overflow-hidden">
      
//       {/* Header */}
//       <div className="px-5 md:px-8 py-5 border-b border-emerald-100 flex items-center justify-between bg-white sticky top-0 z-10">
//         <div className="flex items-center gap-3">
//           <div className="w-1.5 h-5 bg-emerald-600 rounded-full"></div>
//           <div>
//             <h3 className="text-sm md:text-base font-black text-slate-900 tracking-tight uppercase">Lab Diagnostics</h3>
//             <p className="text-[9px] md:text-[10px] font-bold text-emerald-600 uppercase tracking-widest mt-0.5">
//               {loading ? "Syncing..." : `Showing ${recentItems.length} Recent`}
//             </p>
//           </div>
//         </div>
//         <button 
//           className="cursor-pointer bg-emerald-600 text-white px-4 py-2 md:px-6 md:py-2.5 rounded-xl text-[10px] md:text-[11px] font-black uppercase tracking-widest hover:bg-emerald-700 transition-all active:scale-95 shadow-md" 
//           onClick={() => setOpen(true)}
//         >
//           Add Result
//         </button>
...
//       {/* Footer / History Button */}
//       {hasMore && (
//         <div className="border-t border-emerald-100 bg-emerald-50/30 px-6 py-5 flex justify-center items-center">
//           <button 
//             onClick={() => setFullHistoryOpen(true)} 
//             className=" cursor-pointer group flex items-center gap-3 py-2.5 px-6 bg-white border border-emerald-200 rounded-full text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest hover:border-emerald-400 hover:text-emerald-600 transition-all"
//           >
//             <span>Complete Lab History</span>
//             <span className="bg-emerald-50 px-2 py-0.5 rounded-md text-[9px] border border-emerald-200">
//               {items.length}
//             </span>
//             <span>→</span>
//           </button>
...
//         <div className="fixed inset-0 z-[1000] flex items-center justify-center p-2 md:p-8 bg-slate-900/60 backdrop-blur-md">
//           <div className="bg-white w-full max-w-5xl h-full max-h-[90vh] rounded-[2rem] shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in duration-200">
//             <div className="px-6 md:px-8 py-5 border-b border-emerald-100 flex justify-between items-center bg-white">
//               <h2 className="text-lg md:text-xl font-black text-slate-900 tracking-tight uppercase">Diagnostic History</h2>
//               <button onClick={() => setFullHistoryOpen(false)} className="w-10 h-10 rounded-full bg-emerald-50 flex items-center justify-center text-slate-900 font-bold border border-emerald-200">✕</button>
//             </div>
//             <div className="overflow-y-auto flex-1 p-4 md:p-6">
//                <table className="w-full text-left">
//                   <tbody className="divide-y divide-emerald-50">{items.map(item => <LabRow key={item.id} item={item} />)}</tbody>
//                </table>
//             </div>
//           </div>
//         </div>
...
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Panel Type*</label>
//               <select 
//                 className="w-full border border-emerald-200 bg-emerald-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none transition-all focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100" 
//                 value={test} 
//                 onChange={(e) => handleTestChange(e.target.value)}
//               >
//                 <option value="">Select test panel...</option>
...
//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Numeric Result*</label>
//               <input type="number" step="any" className="w-full border border-emerald-200 bg-emerald-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100" value={value} onChange={(e) => setValue(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Observation Date*</label>
//               <input type="date" className="w-full border border-emerald-200 bg-emerald-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100" value={date} onChange={(e) => setDate(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Lab Facility</label>
//               <input className="w-full border border-emerald-200 bg-emerald-50 rounded-xl px-4 py-3 text-sm font-bold text-slate-950 outline-none focus:border-emerald-400 focus:ring-2 focus:ring-emerald-100" value={lab} onChange={(e) => setLab(e.target.value)} />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Reference Range</label>
//               <input className="w-full bg-emerald-100 border border-emerald-200 text-slate-950 rounded-xl px-4 py-3 text-sm font-bold italic" value={range} readOnly />
//             </div>

//             <div className="space-y-2">
//               <label className="text-[10px] md:text-[11px] font-black text-slate-950 uppercase tracking-widest ml-1">Units</label>
//               <input className="w-full bg-emerald-100 border border-emerald-200 text-slate-950 rounded-xl px-4 py-3 text-sm font-bold italic" value={unit} readOnly />
//             </div>
//           </div>

//           <div className="flex justify-end gap-3 pt-6 border-t border-emerald-100">
//             <button className="px-6 py-3 rounded-xl text-[11px] font-black text-slate-950 uppercase tracking-widest hover:bg-emerald-50" onClick={() => setOpen(false)}>Discard</button>
//             <button 
//               className="bg-emerald-600 text-white px-10 py-3.5 rounded-xl text-[11px] font-black uppercase tracking-widest shadow-lg hover:bg-emerald-700 transition-all disabled:bg-slate-300" 
//               onClick={submit} 
//               disabled={loading}
//             >
//               Commit Result
