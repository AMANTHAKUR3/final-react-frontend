...
import { Video, Phone, ArrowLeft, Clock, User, Mic, MicOff, VideoOff, Calendar, CheckCircle, Loader2 } from "lucide-react";
        ...
        <div className="bg-gray-900 px-4 sm:px-6 py-4 sm:py-6 border-t border-gray-700">
          <div className="flex justify-center items-center gap-3 sm:gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 sm:px-6 sm:py-3 bg-[#1DB1A2] hover:bg-[#1DB1A2]/90 text-white rounded-full font-semibold transition-all duration-200 shadow-lg ml-2 sm:ml-4"
