...
import { ArrowLeft, Calendar, Clock, User, Phone, Mail, Stethoscope, Video, Building2, X, Eye, XCircle, Loader2 } from "lucide-react";
    ...
    const fetchAppointments = async () => {
      ...
      try {
        ...
        const mappedAppointments = response.data.map((apt) => ({
          ...
          status: apt.status === "SCHEDULED" ? "Upcoming" : apt.status === "COMPLETED" ? "Completed" : apt.status === "CANCELLED" ? "Cancelled" : apt.status,
    ...
    <div className="min-h-screen bg-linear-to-br from-[#1DB1A2]/6 via-white to-[#aa4a3a]/6">
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 mt-2">View your appointments here</p>
        </div>
          ...
          {appointments.map((appointment) => (
            ...
            >
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2">
                  <Stethoscope size={16} className="text-[#1DB1A2]" />
              ...
              <div className="mt-5 flex gap-3">
                {appointment.status === "Upcoming" && (
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 border border-[#aa4a3a] text-[#aa4a3a] rounded-lg hover:bg-[#aa4a3a]/10 transition-colors font-medium text-sm"
                  >
                    <XCircle size={16} />
                    Cancel
                  </button>
      ...
      {/* View Details Modal - Hidden but functionality preserved */}
      {false && showDetailsModal && selectedAppointment && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
